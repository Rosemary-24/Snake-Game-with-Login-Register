...
import java.util.ArrayList; // storing the segments for teh snakes body
import java.util.Random; // getting random x and y values to palce our food on screen 
import javax.swing.*;
...
public class SnakeGamePanel extends JPanel implements ActionListener, KeyListener {
    ...
    SnakeGamePanel(int boardWidth, int boardHeight) {
        // to distinguish boardwisth, we have one as a parameter and one as member or snake class
